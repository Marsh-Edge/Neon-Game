          ...
          return (
            <a
              ...
              className={cn(
                ...
                "glass glass-border",
                "hover:bg-white/[0.08] hover:border-neon-purple/30",
            ...
            >
              ...
              <span className="text-xs font-medium text-slate-500 group-hover:text-white/80 transition-colors duration-250">
                {cat.name}
              </span>
            </a>
          );
