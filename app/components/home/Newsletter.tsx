  ...
  return (
    <section className="w-full">
      <div className="relative overflow-hidden rounded-2xl glass glass-border">
        {/* Background glow */}
        <div className="absolute inset-0 bg-gradient-to-r from-neon-cyan/[0.04] via-neon-purple/[0.04] to-neon-magenta/[0.04]" />

        <div className="relative flex flex-col sm:flex-row items-center gap-6 px-8 py-8 sm:px-12">
          <div className="flex items-center gap-3.5 shrink-0">
            <div className="flex size-10 items-center justify-center rounded-xl bg-neon-cyan/10 border border-neon-cyan/15">
